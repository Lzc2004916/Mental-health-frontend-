    ...
    <div class="sidebar">
      ...
      <div class="ai-assistant-info">
        <div class="breathing-circle">
          <el-image :src="robotImg" style="width: 25px; height: 25px;" alt="AI助手"></el-image>
        </div>
        ...
        <div class="session-list">
          <div v-for="session in sessionList" :key="session.id" class="session-item"
            ...
            <div class="session-main">
              <span class="session-title-text">{{ session.sessionTitle }}</span>
              ...
              <div class="session-stats">
                <span><el-icon>
                    <ChatRound />
                  </el-icon>{{ session.messageCount || 0 }}</span>
                <span><el-icon>
                    <Clock />
                  </el-icon>{{ session.durationMinutes || 0 }} 分钟</span>
              </div>
            </div>
            <el-button class="session-delete" text type="danger" size="small"
    ...
    <div class="chat-main">
      <div class="chat-header">
        <div class="header-left">
          <div class="chat-avatar">
            <el-image :src="likeImg" style="width: 30px;height: 30px;"></el-image>
          </div>
          <div class="chat-info">
            <h2>宁渡AI助手</h2>
            <p>您贴心的AI心理助手</p>
      ...
      <div class="chat-messages">
        <div class="message-item ai-message" v-if="messages.length === 0">
          <div class="message-avatar">
            <el-image :src="robotImg" style="width: 18px; height: 18px;"></el-image>
          </div>
        ...
        <div v-else class="message-item" v-for="item in messages" :key="item.id"
          :class="item.senderType === 1 ? 'user-message' : 'ai-message'">
          <div class="message-avatar">
            <el-image :src="item.senderType === 1 ? userImg : robotImg" style="width: 18px;height: 18px;"></el-image>
          </div>
          <div class="message-content">
            <div class="message-bubble">
              <!-- AI正在思考中 -->
              <div class="typing-indicator" v-if="item.senderType === 2 && isAiTyping && !item.content">
              ...
              <MarkdownRenderer v-else-if="item.senderType === 2 && !item.isError" :content="item.content"
                :isAiMessage="true"></MarkdownRenderer>
              <!-- 用户输入 -->
      ...
      <div class="chat-input">
        <div class="input-container">
          <!--input输入-->
          <el-input v-model="userMessage" :disabled="isAiTyping" placeholder="请输入您的问题" type="textarea" :rows="3"
            resize="none" clearable @keydown.enter.exact.prevent="handleKeyDown" class="message-input"></el-input>
          <div class="input-footer">
            按 Enter 发送，Shift + Enter 换行
          </div>
        </div>
        <button type="primary" class="send-btn" @click="sendMessage">
          <el-icon>
            <Promotion />
          </el-icon>
        </button>
